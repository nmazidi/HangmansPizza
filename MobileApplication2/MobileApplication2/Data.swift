...
func GETRequest(path: String, completionHandler: @escaping (Bool, [[String: AnyObject]]) -> ()) {
...
func GETRequestByID(path: String, id: Int, completionHandler: @escaping (Bool, [[String: AnyObject]]) -> ()) {
...
func PUTRequest(path: String, id: Int, params: [String: String]) {
    ...
    request.httpBody = encodeParameters(params: params)
...
func POSTRequest(path: String, params: [String: String]) {
