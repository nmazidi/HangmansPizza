...
<body>
	<div>
		<ul>
			...
			<li><a class="active" href="pizzadeals.php">Deals</a></li>
...
?></span></a></li>
			<li style="float:right"><a id='registerButton' href="pizzahome.php?action=checkregister"><span id='registerButton'><?php
if ($_SESSION["username"] != NULL){
...
?></span></a></li>
	...
	<div class="menuSection">
		<h1>Sorry, No deals at this time</h1>
	</div>
