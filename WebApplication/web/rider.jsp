                    ...
                    formApp.controller('FormController', [
                        ...
                        function ($scope, $window, $http, $httpParamSerializer) {
                            ...
                            $scope.submit = function () {
                                $http({
                                    method: 'POST',
                                    url: 'http://xserve.uopnet.plymouth.ac.uk/Modules/INTPROJ/PRCS251Q/api/delivery_rider',
    ...
    <body data-ng-controller="FormController">
        ...
        <div class='page mainSection container'>
            ...
            <fieldset>
                ...
                <input type='text' name='firstName' placeholder="First Name" ng-model="data.delivery_rider.RIDER_FORENAME"><br>
                <label>Last Name:</label>
                <input type='text' name='lastName' placeholder="Last Name" ng-model="data.delivery_rider.RIDER_SURNAME"><br>
                <label>Date of birth:</label>
                <input type="date" name="dob" placeholder="DoB" ng-model="data.delivery_rider.RIDER_DOB">
                <label>E-mail:</label>
